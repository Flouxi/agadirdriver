...
export const SERVICE_PAGES = {
  "/agadir-airport-transfer": {
    title: "Agadir Airport Transfer | Private Pickup",
    description: "Book an Agadir airport transfer to your hotel, Taghazout, Tamraght, or Agadir by WhatsApp.",
  ...
  "/agadir-airport-taxi": {
    title: "Agadir Airport Taxi | Private Pickup",
    description: "Book an Agadir airport taxi from Al Massira Airport to your hotel with flight details by WhatsApp.",
  ...
  "/agadir-taxi": {
    title: "Agadir Taxi | Hotel & Airport Transfers",
    description: "Book an Agadir taxi for hotel transfers, city rides, Taghazout, and local journeys by WhatsApp.",
    h1: "Agadir Taxi",
  ...
  "/private-driver-agadir": {
    title: "Private Driver Agadir | Chauffeur Service",
    description: "Hire a private driver in Agadir for airport transfers, day trips, business travel, and local rides.",
  ...
  "/airport-transfer-taghazout": {
    title: "Airport Transfer Taghazout | Private Ride",
    description: "Book a private airport transfer from Agadir Airport to Taghazout for hotels and surf camps.",
  ...
  "/airport-transfer-tamraght": {
    title: "Airport Transfer Tamraght | Private Ride",
    description: "Arrange a private airport transfer from Agadir Airport to Tamraght with your flight details.",
